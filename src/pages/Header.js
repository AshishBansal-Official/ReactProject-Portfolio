        ...
        <div className="w-full min-h-[min(1080px,100vh)] flex justify-center">
            ...
            <div className="relative flex max-w-6xl w-full mx-4">
                <div className="absolute flex w-full max-w-6xl justify-between">
                    ...
                    <div className="flex items-center tracking-wide font-semibold gap-6 text-white text-lg select-none">
                        <div>Home</div>
                        <div>Skills</div>
                        <div>Projects</div>
                        <div>Contact</div>
                    ...
                    <div className="text-white">
                        ...
                        <div className="flex gap-4 py-4">
                            ...
                            <img
                                ...
                                className="w-10 rounded-lg cursor-pointer"
                            />
                            <div className="bg-gradient-to-l rounded-lg px-2 cursor-pointer flex items-center font-semibold from-[#f06449] to-[#ef3636] ">
                                Download Resume
                            </div>
                        </div>
                    </div>
